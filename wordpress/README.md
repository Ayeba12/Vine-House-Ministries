...
| Gathering tiles (home) | CPT `gathering`, those ticked **Show on home** (up to four, in menu order; the four newest when none is ticked) | `gatherings { … gatheringFields { showOnHome pillarNumber subtitle timing location } }` |
